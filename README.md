...
[![GitHub Super-Linter](https://github.com/redhat-cop/osbuild.composer/workflows/Lint%20Code%20Base/badge.svg)](https://github.com/marketplace/actions/super-linter)
...
```shell
ansible-galaxy collection install git+https://github.com/redhat-cop/osbuild.composer
```
